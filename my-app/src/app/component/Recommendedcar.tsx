...
const RecommendedCars = () => {
  ...
  return (
    <div className="w-full bg-[#F6F7F9] py-10 px-4 lg:px-16">
      <h2 className="text-2xl font-bold mb-8 ">Recommended Cars</h2>
  ...
  <button className="w-[250px] h-[50px] font-semibold text-md text-white rounded-md leading-6 bg-[#3563E9]">
    Show more car
  </button>
</div>
